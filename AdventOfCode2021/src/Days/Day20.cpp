...
namespace Day20 {
	...
	constexpr auto INPUT_FILE_PATH = "data/day20_input.txt";
	constexpr auto TEST_INPUT_FILE_PATH = "data/day20_test_input.txt";
	...
	int run() {
		...
		int32_t p1 = part1(rx);
		printf_s("Solution 20.1: %d\n", p1);

		int32_t p2 = part2(rx);
		printf_s("Solution 20.2: %d\n", p2);

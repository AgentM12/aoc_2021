...
namespace Day19 {
	...
	constexpr auto INPUT_FILE_PATH = "data/day19_input.txt";
	constexpr auto TEST_INPUT_FILE_PATH = "data/day19_test_input.txt";
	...
	int run() {
		...
		int32_t p1 = part1(rx);
		printf_s("Solution 19.1: %d\n", p1);

		int32_t p2 = part2(rx);
		printf_s("Solution 19.2: %d\n", p2);
